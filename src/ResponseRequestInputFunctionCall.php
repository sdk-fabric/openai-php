...
#[Description('A tool call to run a function. See the function calling guide for more information.')]
class ResponseRequestInputFunctionCall extends ResponseRequestInput implements \JsonSerializable, \PSX\Record\RecordableInterface
{
