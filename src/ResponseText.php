...
#[Description('')]
class ResponseText implements \JsonSerializable, \PSX\Record\RecordableInterface
{
    #[Description('An object specifying the format that the model must output.')]
    protected ?ResponseTextFormat $format = null;
    ...
    public function setFormat(?ResponseTextFormat $format): void
    {
        $this->format = $format;
    }
    public function getFormat(): ?ResponseTextFormat
    {
        return $this->format;
    }
